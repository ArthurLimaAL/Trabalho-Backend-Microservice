...
const dishes: Dish[] = [
  { id: "pizza-margherita", name: "Margherita da casa", description: "Molho de tomate assado, fior di latte, manjericão e azeite da praça.", price: 42.9, category: "Pizzas", image: "https://images.unsplash.com/photo-1513104890138-7c749659a591?auto=format&fit=crop&w=900&q=80", tag: "Queridinha" },
  { id: "pizza-calabresa", name: "Calabresa na brasa", description: "Calabresa artesanal, cebola roxa, muçarela e pimenta-de-cheiro.", price: 45.9, category: "Pizzas", image: "https://images.unsplash.com/photo-1548365328-9f547fb9587c?auto=format&fit=crop&w=900&q=80" },
  { id: "burger", name: "Brasa da Praça", description: "Blend da casa, queijo meia-cura, cebola crocante e molho defumado.", price: 36.9, category: "Sanduíches", image: "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?auto=format&fit=crop&w=900&q=80", tag: "Novo" },
  { id: "brownie", name: "Brownie de brigadeiro", description: "Chocolate intenso, creme de baunilha e castanhas tostadas.", price: 18.9, category: "Doces", image: "https://images.unsplash.com/photo-1606313564200-e75d5e30476c?auto=format&fit=crop&w=900&q=80" },
  { id: "focaccia", name: "Focaccia de alho", description: "Massa de fermentação lenta, alho confitado, alecrim e flor de sal.", price: 16.9, category: "Para compartilhar", image: "https://images.unsplash.com/photo-1504674900247-0877df9cc836?auto=format&fit=crop&w=900&q=80" },
  { id: "limonada", name: "Limonada da varanda", description: "Limão espremido, capim-limão e um toque de mel.", price: 10.9, category: "Bebidas", image: "https://images.unsplash.com/photo-1546173159-315724a31696?auto=format&fit=crop&w=900&q=80" },
];
...
function Logo() { return <div className="restaurant-logo"><div className="brand-mark">F</div><span>forno<br /><b>da praça</b></span></div>; }
...
export default function Home() {
  ...
  return <div className="restaurant-app">
    ...
    <main>
      <section className="restaurant-hero"><div className="hero-content"><span className="hero-kicker">COMIDA DE VERDE, SEM PRESSA</span><h1>O forno aceso<br /><em>esperando por você.</em></h1><p>Pizza de fermentação lenta, sanduíches na brasa e sobremesas que chegam quentinhas na sua porta.</p><button className="hero-cta" onClick={() => document.getElementById("cardapio")?.scrollIntoView({ behavior: "smooth" })}>Pedir agora <ArrowRight size={17} /></button><div className="hero-meta"><span><Clock3 size={14} /> 30–45 min</span><span><MapPin size={14} /> taxa a partir de R$ 0</span></div></div><div className="hero-image"><img src="https://images.unsplash.com/photo-1513104890138-7c749659a591?auto=format&fit=crop&w=1200&q=80" alt="Pizza artesanal saindo do forno" /><div className="hero-stamp">feito<br /><b>na praça</b></div></div></section>
